...
def add_parts_1(grader, submission):
    ...
    grader.addBasicPart('1b-1', t_1b_1, maxPoints=1, maxSeconds=2)
    ...
    grader.addBasicPart('1b-2', t_1b_2, maxPoints=1, maxSeconds=2)
...
def add_parts_3(grader, submission):
    ...
    def t_3b_2():
        ...
        # grader.requireIsEqual(
        #     'the red dog',
        #     submission.segmentAndInsert('thrddg', bigramCost, fills))
        # grader.requireIsEqual(
        #     'machine learning and artificial intelligence',
        #     submission.segmentAndInsert('mchnelrnngndrtfclntllgnc', bigramCost, fills))

    grader.addBasicPart('3b-2', t_3b_2, maxPoints=1, maxSeconds=2)
...
def grade():
    ...
    grader.addBasicPart('init', lambda: getRealCosts(), maxPoints=1, maxSeconds=15)
